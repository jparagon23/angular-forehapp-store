...
export const createOrder = createAction('[Orders] Create Order', props<{ addressId: number; paymentMethod: PaymentMethod; couponCode?: string; couponStoreId?: number; referralCode?: string }>());
